...
async function main() {
  ...
  const amountToMint = ethers.parseUnits("1000000", 18); // 1 million GDV tokens
  ...
  try {
    ...
    console.log(`Successfully minted ${ethers.formatUnits(amountToMint, 18)} GDV tokens`);
    console.log(`New balance: ${ethers.formatUnits(balance, 18)} GDV tokens`);
